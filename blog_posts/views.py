...
def handler403(request, exception): # função para direcionar a pagina de erro 403
    return    render(request, 'erro403.html')

def handler404(request, exception): # função para direcionar a pagina de erro 404
    return    render(request, 'erro404.html')

def handler500(request): # função para direcionar a pagina de erro 505
